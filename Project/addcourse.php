...
<html lang="en">
  <meta charset="utf-8">
    ...
    <form class="form-horizontal" action="addcourse_check.php" method="post" role="form">
            ...
            ?>
				<h3><strong>Add Course Page</strong></h3>
			</div>
		    
		  </div>
		  	
		  <div class="form-group" form-group-lg>
		    <label for="user" class="col-sm-2 control-label">Course ID</label>
		    <div class="col-sm-4">
		      <input type="text" name="course_id" required="required" class="form-control" placeholder="Course ID">
		    </div>
		  </div>
		  
		  <div class="form-group" form-group-sm>
		    <label for="inputPassword" class="col-sm-2 control-label">Course Name</label>
		    <div class="col-sm-4">
          ...
          <div class="form-group" form-group-sm>
            <label for="inputPassword" class="col-sm-2 control-label">Course Type</label>
            <div class="col-sm-4">
