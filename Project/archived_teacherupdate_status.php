    ...
    <div class="mainmenu-area">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <?php
                        	...
                        	Print '<li class="active"><a href="archived_teacherupdate_status.php?id1='.$teacher_id.'&id2='.$course_id.'&p_id='.$p_id.'">Status</a></li>';  
		...
		<div class="container">
			...
			<?php
				...
				Print '<h2 align="center">Archived Status</h2>';
