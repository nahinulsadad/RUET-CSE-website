...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" >
        <div class="row">
            <div class="col-sm-12" id="nahin" style="height:70%;">
			  ...
			  <div class="tab-content" style="margin-bottom: 0px;">
					    ...
					    <tbody>
					      <tr>
					        <td class="col-md-3" style="background-color: rgb(23, 167, 139) !important; ">
					        	<h4 style="margin:3px; color:white; text-align:center;">31 December</h4>
					        </td>
					        <td class="col-md-9"><a href="#my_modal2" data-toggle="modal" data-delete="ok">
                    <h4 style="margin: 5px; color:black;">Board Viva (2010 series, 4th year 8th semester)</h4></a>
                  </td>
					      ...
					      <tr>
					        <td class="col-md-3" style="background-color: rgb(23, 167, 139) !important; ">
					        	<h4 style="margin:3px; color:white; text-align:center;">32 February</h4>
					        </td>
					        <td class="col-md-9"><h4 style="margin: 5px;">Board Viva (2010 series, 4th year 8th semester)Board Viva (2010 series, 4th year 8th semester)</h4></td>
					      </tr>
					      <tr>
					        <td class="col-md-2" style="background-color: rgb(23, 167, 139) !important; ">
					        	<h4 style="margin:3px; color:white; text-align:center;">3 March</h4>
					        </td>
					        <td class="col-md-10"><h4 style="margin: 5px;">Board Viva (2010 series, 4th year 8th semester)</h4></td>
					      </tr>
					      <tr>
					        <td class="col-md-2" style="background-color: rgb(23, 167, 139) !important; ">
					        	<h4 style="margin:3px; color:white; text-align:center;">3 March</h4>
			    ...
			    <div id="PG" class="tab-pane fade" style="max-height: 250px; overflow-y:scroll;">
					    ...
					    <tbody>
					      <tr>
					        <td class="col-md-3" style="background-color: rgb(23, 167, 139) !important; ">
					        	<h4 style="margin:3px; color:white;">3 March</h4>
					        </td>
					        <td class="col-md-9"><h4 style="margin: 5px;">Board Viva (2010 series, 4th year 8th semester)Board Viva (2010 series, 4th year 8th semester)</h4></td>
					      </tr>
					      <tr>
			    ...
			    <div id="Other" class="tab-pane fade" style="max-height: 250px; overflow-y:scroll;">
					    ...
					    <tbody>
					      <tr>
					        <td class="col-md-2" style="background-color: rgb(23, 167, 139) !important; ">
					        	<h4 style="margin:3px; color:white;">3 January</h4>
					        </td>
					        <td class="col-md-10"><h4 style="margin: 5px;">Board Viva (2010 series, 4th year 8th semester)</h4></td>
					      </tr>
					      <tr>
					        <td class="col-md-3" style="background-color: rgb(23, 167, 139) !important; ">
					        	<h4 style="margin:3px; color:white;">3 December</h4>
					        </td>
					        <td class="col-md-9"><h4 style="margin: 5px;">Board Viva (2010 series, 4th year 8th semester)</h4></td>
					      </tr>
					    </tbody>
					  </table>
			    </div>
