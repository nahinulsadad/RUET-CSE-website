...
<html lang="en">
  <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="addnotice.php">Add notice</a></li>
                    </ul>
                </div>  
            </div>
        </div>
        ...
        if(isset($_GET['id']))
        {
            if($_GET['id']==1)
            {
                ...
                print '<script type="text/javascript">
                            setTimeout(function () {
                                window.location.href= "addnotice.php"; // the redirect goes here
                            },4000); // 5 seconds
                    </script>';
            }
    ...
    <form class="form-horizontal" action="addnotice_check.php" method="post" role="form">
            ...
            ?>
				<h3><strong>Add Notice Page</strong></h3>
			</div>
		    
		  </div>
		  	
		  <div class="form-group" form-group-lg>
		    <label for="user" class="col-sm-2 control-label">Notice</label>
		    <div class="col-sm-4">
		      <input type="text" name="notice" required="required" class="form-control" placeholder="Notice">
		    </div>
		  </div>
		  
		  <div class="form-group" form-group-sm>
		    <label for="inputPassword" class="col-sm-2 control-label">Detail</label>
		    <div class="col-sm-4">
		      <input type="text" name="detail" required="required" class="form-control" placeholder="Detail">
		    </div>
		  </div>

          <div class="form-group" form-group-sm>
            <label for="inputPassword" class="col-sm-2 control-label">Notice Type</label>
            <div class="col-sm-4">
        ...
        <div class="form-group" form-group-sm>
            <label for="inputPassword" class="col-sm-2 control-label">Upload</label>
            <div class="col-sm-4">
		 ...
		 <div class="form-group">
    		    <div class="col-sm-offset-2 col-sm-4">
                    <button type="submit" class="btn btn-primary" value="login"> Add </button>
		        </div>
		</div>
	</form>
    <br>
